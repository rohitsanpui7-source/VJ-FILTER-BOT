...
API_ID = int(environ.get('API_ID', '24305441'))
API_HASH = environ.get('API_HASH', 'c846f53d55b3b9c0a0d38085ea782c50')
BOT_TOKEN = environ.get('BOT_TOKEN', "8306975197:AAF-cSQAu-siurzrB9khcQPdYUseBuZCO5E")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7056932289').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1003013289083'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1003036938511').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rohitsanp:8shs67@cluster0.qf7bipx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
